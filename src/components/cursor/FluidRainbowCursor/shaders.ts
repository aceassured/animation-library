// src/FluidRainbowCursor/shaders.ts

/**
 * All shaders from original Splash Cursor implementation.
 * These are exported as plain strings so they can be compiled
 * inside WebGL programs in simulation.ts
 */
